<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top6(all).aspx.cs" Inherits="MoviePractice.Movielist.Top6_all_" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Image ID="Image1" runat="server" Height="400px" ImageUrl="~/Image/연도별/전체/2020/6.png" />
        <br />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/Image/연도별/전체/2020/66.png" />
        <br />
        <br />
    </form>
</body>
