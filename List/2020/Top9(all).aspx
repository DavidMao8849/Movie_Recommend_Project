<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top9(all).aspx.cs" Inherits="MoviePractice.Movielist.Top9_all_" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Image ID="Image1" runat="server" Height="400px" ImageUrl="~/Image/연도별/전체/2020/9.png" />
        <br />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/Image/연도별/전체/2020/99.png" />
    </form>
</body>
</html>
