<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top7(all).aspx.cs" Inherits="MoviePractice.Movielist.Top7_all_" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Image ID="Image1" runat="server" Height="400px" ImageUrl="~/Image/연도별/전체/2020/7.png" />
        <br />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/Image/연도별/전체/2020/77.png" />
        <br />
        <br />
    </form>
</body>
