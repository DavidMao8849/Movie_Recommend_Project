<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top1.aspx.cs" Inherits="MoviePractice.Movielist.Top1_all_" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Image ID="Image1" runat="server" Height="400px" ImageUrl="~/Image/연도별/전체/2019/1.png" />
        <br />
        <br />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/Image/연도별/전체/2019/11.png" />
        <br />
        <br />
    </form>
</body>
